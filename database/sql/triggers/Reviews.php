...
return function () {
    ...
    DB::unprepared('DROP TRIGGER IF EXISTS after_insert_review;');
    DB::unprepared('DROP TRIGGER IF EXISTS after_update_review;');
    DB::unprepared('DROP TRIGGER IF EXISTS after_delete_review;');

    // Create after_update_review trigger
    DB::unprepared('
    CREATE TRIGGER after_insert_review
    AFTER INSERT ON reviews
    FOR EACH ROW
    ...
    // Create after_delete_review trigger
    DB::unprepared('
    CREATE TRIGGER after_delete_review
    AFTER DELETE ON reviews
    FOR EACH ROW
